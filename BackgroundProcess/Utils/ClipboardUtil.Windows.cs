...
namespace BackgroundProcess.Utils
{
    public static partial class ClipboardUtil
    {
        ...
        private static bool OpenW(IntPtr hOwner, bool bEmpty)
        {
            ...
            if (h == IntPtr.Zero)
            {
                h = Program.Systray.MainForm.Handle;
            }
        ...
        {
            bool bUni = (bForceUni.HasValue ? bForceUni.Value : Properties.Settings.Default.IsUnicodeUsed);
        ...
        {
            if (!Properties.Settings.Default.UseClipboardViewerIgnoreFormat) return true;
            ...
            return SetDataW(uIgnoreFmt, Program.GetApplicationName(), null);
        }
    }
}
